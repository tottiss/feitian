...
var iid = '<?php echo ($item["num_iid"]); ?>';
var click_url = 'http://g.click.taobao.com/q?pid=<?php echo ($pid); ?>&ct=url%3Dhttp%253A%252F%252Fitem.taobao.com%252Fitem.htm%253Fid%253D<?php echo ($item["num_iid"]); ?>';
var forwardUrl = "<?php echo C('ftx_site_url');?>/index.php?m=jump&a=index&iid=<?php echo ($item['num_iid']); ?>&date="+new Date();
var itemUrl = "http://detail.tmall.com/item.htm?id=<?php echo ($item['num_iid']); ?>";
