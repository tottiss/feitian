...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="__STATIC__/css/admin/new.css" />
...
<div id="header">
    ...
    欢迎您：<a title="admin" href="javascript:;"><?php echo ($my_admin["username"]); ?> [<?php echo ($my_admin["rolename"]); ?>]</a>
    <a href="<?php echo u('index/logout');?>">[<?php echo L('logout');?>]</a>
    <a target="_blank" href="<?php echo C('ftx_site_url');?>">[<?php echo L('site_home');?>]</a>
    </div>
    <div id="nav" class="nav" >    
    	<ul id="J_tmenu">	
            <li class="current"><a href="javascript:;" data-id="0" hidefocus="true" style="outline:none;">后台管理</a></li>
			<?php if(is_array($top_menus)): $i = 0; $__LIST__ = $top_menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li class="normal"><a href="javascript:;" data-id="<?php echo ($val["id"]); ?>" hidefocus="true" style="outline:none;"><?php echo L($val['name']);?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
</div>
<!-- 
<div id="header">
    ...
    <div class="fl">
		...
		您好！<b><?php echo ($my_admin["username"]); ?></b> [<?php echo ($my_admin["rolename"]); ?>]
        	&nbsp;&nbsp;&nbsp;<a href="<?php echo u('index/logout');?>">[<?php echo L('logout');?>]</a>
			&nbsp;<a href="<?php echo C('ftx_site_url');?>" target="_blank">[<?php echo L('site_home');?>]</a>
        </div>
    </div>
