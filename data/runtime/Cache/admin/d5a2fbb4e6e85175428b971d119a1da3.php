...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <div class="page-container">
            <h1>登录(Login)</h1>
            <form action="<?php echo U('index/login');?>" method="post" name="myform" id="myform">
                <input type="text" name="username" class="username" placeholder="请输入您的用户名！">
                <input type="password" name="password" class="password" placeholder="请输入您的用户密码！">
               
                <p class="bt1">
                	<input type="text" class="Captcha" name="verify_code" placeholder="请输入验证码！">
                	<img title="<?php echo (L("refresh_verify_code")); ?>" class="verify_img" src="<?php echo U('index/verify_code', array('t'=>time()));?>" align="absmiddle"/>
                	<div class="clear"></div>
                </p>
