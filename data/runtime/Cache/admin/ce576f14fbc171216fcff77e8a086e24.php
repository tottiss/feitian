        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
					...
					&nbsp;&nbsp;分类 :
                    <select class="J_cate_select mr10" data-pid="0" data-uri="<?php echo U('items_cate/ajax_getchilds', array('type'=>0));?>" data-selected="<?php echo ($search["selected_ids"]); ?>"></select>
					...
					&nbsp;&nbsp;掌柜 :
					<input type="text" name="nick" class="input-text" size="12" value="<?php echo ($search["nick"]); ?>" />
    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="100">掌柜</th>
                <th width="70"><span data-tdtype="order_by" data-field="original_price">原价(元)</span></th>
                <th width="70"><span data-tdtype="order_by" data-field="coupon_price">价格(元)</span></th>
                ...
                <th width="40"><span data-tdtype="order_by" data-field="pass"><?php echo L('pass');?></span></th>
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="right">
                    <div class="img_border"><a href="http://item.taobao.com/item.htm?id=<?php echo ($val["num_iid"]); ?>" target="_blank"><img src="<?php echo ($val['pic_url']); ?>" width="32" width="32" class="J_preview" data-bimg="<?php echo ($val['pic_url']); ?>"></a></div>
                </td>
                ...
                <td align="center" class="red"><?php echo ($val["original_price"]); ?></td> 
                <td align="center" class="red"><?php echo ($val["coupon_price"]); ?></td> 
				<td align="center" class="red"><?php echo ($val["coupon_rate"]); ?></td> 
				<td align="center"><span data-tdtype="edit" data-field="volime" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["volume"]); ?></span></td>
                <td align="center"><span data-tdtype="edit" data-field="ordid" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["ordid"]); ?></span></td>
                <td align="center"><img data-tdtype="toggle" data-id="<?php echo ($val["id"]); ?>" data-field="pass" data-value="<?php echo ($val["pass"]); ?>" src="__STATIC__/images/admin/toggle_<?php if($val["pass"] == 0): ?>disabled<?php else: ?>enabled<?php endif; ?>.gif" /></td>
