...
<div class="pad_lr_10" style="margin-top:10px;">
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('items_comment/ajax_edit');?>">
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                	<a href="javascript:void(0);" class="J_confirmurl" data-uri="<?php echo U('items_comment/delete', array('id'=>$val['id'], 'item_id'=>$val['item_id']));?>" data-acttype="ajax" data-msg="<?php echo sprintf(L('confirm_delete_one'),'该评论');?>"><?php echo L('delete');?></a></td>
    ...
    <div class="btn_wrap_fixed">
        ...
        <input type="button" class="btn" data-tdtype="batch_action" data-acttype="ajax" data-uri="<?php echo U('items_comment/delete');?>" data-name="id" data-msg="<?php echo L('confirm_delete');?>" value="<?php echo L('delete');?>" />
