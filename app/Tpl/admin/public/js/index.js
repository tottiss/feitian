...
$(function(){
    ...
    $('#J_tmenu a').live('click', function(){
        ...
        //改变样式
        $(this).parent().removeClass("normal").addClass("current")
        .siblings().removeClass("current").addClass("normal");
        //改变左侧
    ...
    $('.J_lmenu a').live('click', function(){
        ...
        if(_li[0]){
            ...
            $(rframe[0].contentWindow.document).ready(function(){
                ...
                //add
                $('#J_mtab_h').empty();
                $('#J_mtab_h').html("<li class=\"current\" data-id=\"0\"><span><a>后台首页</a></span></li>");
