...
class indexAction extends BackendAction {
    ...
    public function panel() {
        ...
        $system_info = array(
            'ftxia_version' => FTX_VERSION . '  '. FTX_RELEASE .' [<a href="http://#" class="blue" target="_blank">查看最新版本</a>]',
            ...
            'safe_mode' => (boolean) ini_get('safe_mode') ?  '支持' : '不支持',
            'zlib' => function_exists('gzclose') ?  '支持' : '不支持',
            'curl' => function_exists("curl_getinfo") ? '支持' : '不支持',
